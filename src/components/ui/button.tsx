  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elevated hover:shadow-soft px-8 py-3 text-base font-semibold rounded-full",
        "hero-outline": "border-2 border-foreground/20 bg-transparent text-foreground hover:bg-secondary hover:border-foreground/30 px-8 py-3 text-base font-medium rounded-full",
        card: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft w-full justify-center rounded-full",
      },
      size: {
