        ...
        <div className="min-h-screen bg-background">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border h-16 flex items-center justify-between px-6 lg:px-12">
                <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate("/")}>
                    ...
                    <span className="font-bold text-xl tracking-tight">FractoLand <span className="text-amber-600">Builder</span></span>
                </div>
                <div className="flex items-center gap-4">
                    <Button variant="ghost" onClick={() => navigate("/developer/login")}>
                        Sign In
                    </Button>
                    <Button className="bg-amber-500 hover:bg-amber-600 text-white" onClick={() => navigate("/developer/register")}>
                        Join as Builder
                    </Button>
                </div>
            </nav>
            ...
            <main className="pt-16">
                {/* Hero Section */}
                <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-amber-50/50 to-background">
                    <div className="container px-4 md:px-6 relative z-10">
                        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-100 text-amber-700 font-medium text-sm mb-6 border border-amber-200">
                                ...
                                <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-br from-gray-900 to-gray-600 bg-clip-text text-transparent">
                                    ...
                                    <span className="text-amber-500">Tokenized Funding</span>
                                </h1>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Button size="lg" className="h-12 px-8 text-base bg-amber-500 hover:bg-amber-600 text-white" onClick={() => navigate("/developer/register")}>
                                        Start Bidding
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                        <div className="absolute top-1/4 left-10 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl" />
