...
import { ArrowUpRight, Download, Filter, MapPin, TrendingUp } from "lucide-react";
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between">
                  ...
                  <span className={`text-xs font-medium px-2 py-1 rounded-full ${investment.status === "unlocked"
              ...
              <div className="flex items-center gap-6 md:gap-8">
                ...
                <div className="text-center">
                  ...
                  <p className="font-semibold text-foreground">{investment.exitDate}</p>
                </div>
                <div className="text-center">
