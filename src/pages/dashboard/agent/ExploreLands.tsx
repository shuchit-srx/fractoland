...
const AgentExploreLands = () => {
  ...
  useEffect(() => {
    ...
    const stateParam =
      selectedFilter === "all"
        ? undefined
        : selectedFilter === "bangalore"
          ? "Karnataka"
          : selectedFilter === "mumbai"
            ? "Maharashtra"
            : selectedFilter === "hyderabad"
              ? "Telangana"
              : undefined;
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredLands.map((land, index) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="font-semibold text-foreground text-lg mb-2">{land.name}</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-green-600">Up to 2%</p>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    ...
                    <span>
                      {land.availableTokens}/{land.totalTokens}
                    </span>
                  </div>
                </div>
